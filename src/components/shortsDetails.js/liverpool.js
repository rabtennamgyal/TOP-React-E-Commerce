import one from '../../assets/shorts/liverpool.webp';
import two from '../../assets/shorts/liverpool2.webp';
import three from '../../assets/shorts/liverpool3.webp';

function LiverpoolShorts() {
    ...
    setInterval(() => {
        ...
        for (let i = 0; i < imgs.length; i++) {
            imgs[i].addEventListener('mouseover', () => {
                const cur = arrs[i];
                document.getElementById('liverpoolshorts').src = cur;
            });
        };
    });
        ...
        <div className="productDetails">
            <div className="divOne">
                <div className='mainimg'>
                    <img id='liverpoolshorts' src={one} alt='img' />
                </div>
...
export default LiverpoolShorts;